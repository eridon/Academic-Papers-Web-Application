...
/**
 * WipTrack Component - displays all the wip track papers in the database.
 * 
...
function WipTrack(props) {
    // Declare state variables
    const [selectTrack, setSelectTrack] = useState('wip');
    ...
    return (
        <div>
            ...
            <p>
                This page allows you to view a list of Work-In-Progress Papers that were presented at the CHI PLAY 2021 conference.
