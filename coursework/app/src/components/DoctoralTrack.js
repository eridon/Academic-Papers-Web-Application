...
/**
 * DoctoralTrack Component - displays all the doctoral track papers in the database.
 * 
...
function DoctoralTrack(props) {
    // Declare state variables
    const [selectTrack, setSelectTrack] = useState('doctoral');
    ...
    return (
        <div>
            ...
            <p>
                This page allows you to view a list of Doctoral Consortium Papers that were presented at the CHI PLAY 2021 conference.
