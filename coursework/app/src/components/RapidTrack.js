...
/**
 * RapidTrack Component - displays all the rapid track papers in the database.
 * 
...
function RapidTrack(props) {
    // Declare state variables
    const [selectTrack, setSelectTrack] = useState('rapid');
    ...
    return (
        <div>
            ...
            <p>
                This page allows you to view a list of Rapid Communications Papers that were presented at the CHI PLAY 2021 conference.
