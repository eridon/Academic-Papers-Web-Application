...
/**
 * FullpapersTrack Component - displays all the fullpapers track papers in the database.
 * 
...
function FullpapersTrack(props) {
    // Declare state variables
    const [selectTrack, setSelectTrack] = useState('fullpapers');
    ...
    return (
        <div>
            ...
            <h1>{capitalisedTrack}</h1>
            <p>
                This page allows you to view a list of Full Papers that were presented at the CHI PLAY 2021 conference.
...
export default FullpapersTrack;
