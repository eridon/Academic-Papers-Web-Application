...
/**
 * InteractivityTrack Component - displays all the Interactivity track papers in the database.
 * 
...
function InteractivityTrack(props) {
    // Declare state variables
    const [selectTrack, setSelectTrack] = useState('Interactivity');
    ...
    return (
        <div>
            ...
            <p>
                This page allows you to view a list of Interactivity Papers that were presented at the CHI PLAY 2021 conference.
...
export default InteractivityTrack;
